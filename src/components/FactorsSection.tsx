...
export default function FactorsSection({ horizon }: FactorsSectionProps) {
        ...
        <Reveal>
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-400">
              Twelve researched drivers shape the forecast paths. Relevance automatically reweights
              as you change the horizon — short horizons emphasize policy and inventories; longer
              ones highlight structural transition and scarcity.
            </p>
          </div>
        </Reveal>
